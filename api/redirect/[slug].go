...
// RedirectHandler redirects to the URL previously associated to the given slug, or to https://casca.to/goto if no URL is available.
func RedirectHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Redirect(w, r, "https://casca.to/goto", http.StatusPermanentRedirect)
		return
	}
